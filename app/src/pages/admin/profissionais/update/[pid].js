      ...
      <div className="d-flex justify-content-center p-2">
        <div className="container">
          <div className="row border-bottom">
            <h3>Editar Cadastro de Profissional</h3>

            <form method="POST" id="formEdicao">
              {/* Primeiro Nome */}
              <div className="mb-3">
                <label htmlFor="primeiroNome" className="form-label">Primeiro Nome:</label>
                <input type="text" id="primeiroNome" name="primeiroNome" className="form-control" maxLength="45" value={profissional.primeiroNome} onChange={handleChange} required />
              </div>

              {/* Último Nome */}
              <div className="mb-3">
                <label htmlFor="ultimoNome" className="form-label">Último Nome:</label>
                <input type="text" id="ultimoNome" name="ultimoNome" className="form-control" maxLength="45" value={profissional.ultimoNome} onChange={handleChange} required />
              </div>

              {/* Pedagogo */}
              <div className="mb-3">
                <label htmlFor="pedagogo" className="form-label">É pedagogo?</label>
                <select id="pedagogo" name="pedagogo" className="form-select" value={profissional.pedagogo} onChange={handleChange} required>
              ...
              <div className="mb-3">
                ...
                <select id="profissao" name="profissao" className="form-select" value={profissional.profissao} onChange={handleChange} required>
              ...
              <div className="d-flex justify-content-end">
                <button type="button" className="btn btn-primary me-2" onClick={handleUpdateProfissional}>Atualizar</button>
