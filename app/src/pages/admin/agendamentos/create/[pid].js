          ...
          <div className="row border-bottom">
            ...
            <form method="POST" id="formAgendamento"  onSubmit={handleCreateAgendamento}>
              ...
              <div className="mb-3">
                ...
                <select id="paciente" name="paciente" className="form-select" value={agendamento.paciente} onChange={handleChange} required>
              ...
              <div className="mb-3">
                ...
                <textarea
                  ...
                  onChange={(e) => setAgendamento({ ...agendamento, descricao: e.target.value })}
                  required
                />
              </div>
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  min={todayDate} // Data mínima para seleção (hoje)
                  required
                />
              </div>
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  disabled={!agendamento.data} // Só habilita quando a data for selecionada
                />
              </div>
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  disabled={!agendamento.horaInicio} // Só habilita quando a hora de início for selecionada
                />
              </div>

              {/* Meses de Retorno */}
             <div className="mb-3">
             <label htmlFor="mesesRetorno" className="form-label">Meses de Retorno:</label>
             <select
                 id="mesesRetorno"
                 name="mesesRetorno"
                 ...
                 <option key={i} value={i}>{i} meses</option>
                 ))}
             </select>
             </div>
              ...
              <div className="form-group">
                ...
                >Salvar</button>
                <Link className="btn btn-outline-info" href={pid ? `/admin/agendamentos/index/${pid}` : "#"}>Voltar</Link>
              </div>
            </form>
          </div>
        </div>
