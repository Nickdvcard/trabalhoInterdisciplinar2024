          ...
          <div className="row border-bottom">
            ...
            <form method="POST">
               ...
               <div className="mb-3">
                ...
                <input type="text" id="primeiroNome" name="primeiroNome" className="form-control" maxLength="45" value={paciente.primeiroNome} onChange={handleChange} required />
              </div>

              {/* Último Nome */}
              <div className="mb-3">
                <label htmlFor="ultimoNome" className="form-label">Último Nome:</label>
                <input type="text" id="ultimoNome" name="ultimoNome" className="form-control" maxLength="45" value={paciente.ultimoNome} onChange={handleChange} required />
              </div>

              {/* Observações */}
              <div className="mb-3">
                <label htmlFor="observacoes" className="form-label">Observações:</label>
                <textarea id="observacoes" name="observacoes" className="form-control" placeholder="Observações opcionais" maxLength="200" value={paciente.observacoes} onChange={handleChange}></textarea>
              </div>
              ...
              <div className="mb-3">
                ...
                <input type="text" id="cep" name="cep" className="form-control" value={paciente.cep} onChange={handleChange} maxLength="9"/>
              </div>
              ...
              <div className="mb-3">
                <button type="button" className="btn btn-primary" onClick={handleUpdatePaciente}>Salvar</button>
              </div>
            </form>
          </div>
        </div>
