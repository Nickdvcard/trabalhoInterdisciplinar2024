        ...
        <div className="container">
          ...
          <div className="row">
            {pacientes.map(paciente => (
              <div key={paciente.idPacientes} className="col-md-4 mb-3" id={`paciente-${paciente.idPacientes}`}>
                <div className="card" data-id={paciente.idPacientes}>
                  <div className="card-body">
                    <h5 className="card-title">{paciente.primeiroNome} {paciente.ultimoNome}</h5>
                    ...
                    <p className="card-text"><strong>Endereco:</strong> {paciente.logradouro}, {paciente.numero}</p>
                    ...
                    <div>
                      <PatientAction pid={paciente.idPacientes}></PatientAction> 
                    </div>
                  </div>
                </div>
              </div>
